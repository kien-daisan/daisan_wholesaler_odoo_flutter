package webkul.opencart.mobikul.mlkit.textdetector
...
class TextRecognitionProcessor(private val activityInstance: CameraSearchActivity) : VisionProcessorBase<Text>(activityInstance) {
